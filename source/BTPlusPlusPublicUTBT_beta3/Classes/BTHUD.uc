...
{
	local float HoriSpeed;
	local float VertSpeed;
	local float YY, XX;

	HoriSpeed = Sqrt(P.Velocity.X**2 + P.Velocity.Y**2) + 0.5;
	VertSpeed = Abs(P.Velocity.Z) + 0.5;
