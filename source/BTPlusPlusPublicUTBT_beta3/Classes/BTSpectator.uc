...
replication
{
	...
	reliable if(Role < ROLE_Authority)
		JumpFrom, Chase, TeleSpec, lastRotation, SpecTP;
}
//=============================================================================
...
// SPECTP - Teleport 1500 units forward
//=============================================================================
exec function SpecTP()
{
...
// fixing spectator flymode getting fucked when adminlogout
//==================
function StartWalk()
{
